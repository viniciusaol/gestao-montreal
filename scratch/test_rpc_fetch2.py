...
url = "https://ehhjnwosqcrfwonqhfoz.supabase.co/rest/v1/rpc/mt_buscar_vendas_existentes"
...
with urllib.request.urlopen(req) as resp:
    ...
    print(f"Fetched ALL {len(data)} sales from RPC mt_buscar_vendas_existentes with Range in {elapsed:.2f} seconds!")
