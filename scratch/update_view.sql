                 ...
                 SELECT rf.item_key,
                    ...
                    COALESCE(
                        CASE
                            ...
                            WHEN (rf.description ~~* '%Leandro Bonete%'::text OR rf.description ~~* '%Leandro B.%'::text OR rf.description ~~* '%Leandro%'::text) OR rf.description ~~* '%Leandro B.%'::text THEN 'Leandro Bonete'::text
...
CASE
 ...
 WHEN b_su(b.description ~~* '%Leandro Bonete%'::text OR b.description ~~* '%Leandro B.%'::text OR b.description ~~* '%Leandro%'::text) THEN 'Leandro Bonete'::text
