...
ELSE COALESCE(rf.valor_bruto, rf.valor_faturamento)
                 ...
                 SELECT p.customer_code,
                    ...
                    b.start_time,
                        CASE
                            WHEN b.booking_id = 11830 THEN 'Leandro Bonete'::text WHEN b.booking_id = 4725 THEN 'Rodrigo Assunção'::text
                    ...
                    COALESCE(
                        ...
                        END, ( SELECT prof.professor
                           FROM ( SELECT DISTINCT ON (p_sub.customer_code) p_sub.customer_code,
                                    COALESCE(
CASE
 WHEN b_sub.booking_id = 11830 THEN 'Leandro Bonete'::text WHEN b_sub.booking_id = 4725 THEN 'Rodrigo Assunção'::text
